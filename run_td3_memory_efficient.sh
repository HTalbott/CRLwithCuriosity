...
# TD3 Benchmark Automation Script - Memory Efficient Version
# Runs TD3 without HER on multiple environments with seeds 0 through 9
# Runs one environment at a time to reduce memory usage
...
echo "Running one environment at a time to reduce memory usage"
echo "=============================================================="
...
for ENV in "${ENVIRONMENTS[@]}"; do
    ...
    echo "================================"
    sleep 10  # Longer delay between environments to ensure memory is freed
done
