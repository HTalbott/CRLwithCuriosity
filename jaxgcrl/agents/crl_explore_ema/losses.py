...
def update_actor_and_alpha(config, networks, transitions, training_state, key):
    def actor_loss(actor_params, target_critic_params, log_alpha, transitions, key, env_steps):
        ...
        # Exploration bonus: distance from batch centroid in representation space
