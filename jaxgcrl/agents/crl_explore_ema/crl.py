...
@dataclass
class CRL_EXPLORE_EMA:
    """CRL with exploration bonus AND EMA-smoothed target critic for actor loss.

    Combines the representation-space novelty bonus from CRL_EXPLORE with
    an EMA target critic that provides a more stable optimization surface
    for the actor."""
