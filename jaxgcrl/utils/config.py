...
from jaxgcrl.agents import CRL, CRL_EMA, CRL_EMA_GOAL, CRL_EMA_GOAL_TEMP, CRL_EMA_HER, CRL_EXPLORE, CRL_EXPLORE_EMA, CRL_PLUS, CRL_TEAMMATE, PPO, PPO_CRL, SAC, TD3

from .env import legal_envs

# agent configurations
AgentConfig = Union[CRL, CRL_EMA, CRL_EMA_GOAL, CRL_EMA_GOAL_TEMP, CRL_EMA_HER, CRL_EXPLORE, CRL_EXPLORE_EMA, CRL_PLUS, CRL_TEAMMATE, PPO, PPO_CRL, SAC, TD3]
